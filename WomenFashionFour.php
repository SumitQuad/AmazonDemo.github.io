...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('21') ";
...
<p style="color:blue;margin-left:2%;">HandBags</p>
...
document.getElementById("img5").src="images/WomenFashion70ThumbnailThirteen.jpg";
...
document.getElementById("img5").src="images/WomenFashion70ThumbnailFourteen.jpg";
...
document.getElementById("img5").src="images/WomenFashion70ThumbnailFifteen.jpg";
...
document.getElementById("img5").src="images/WomenFashion70ThumbnailSixteen.jpg";
