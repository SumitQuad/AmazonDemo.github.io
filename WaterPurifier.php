...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('27') ";
...
<p style="color:blue;margin-left:2%;">Water Purifier</p>
...
document.getElementById("img5").src="images/WaterPurifiersThumbnail1.jpg";
...
document.getElementById("img5").src="images/WaterPurifiersThumbnail2.jpg";
...
document.getElementById("img5").src="images/WaterPurifiersThumbnail3.jpg";
...
document.getElementById("img5").src="images/WaterPurifiersThumbnail4.jpg";
