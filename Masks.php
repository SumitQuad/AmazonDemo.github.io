...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('32') ";
...
<p style="color:blue;margin-left:2%;">Mask</p>
...
document.getElementById("img5").src="images/MasksThumbnail1.jpg";
...
document.getElementById("img5").src="images/MasksThumbnail2.jpg";
...
document.getElementById("img5").src="images/MasksThumbnail3.jpg";
...
document.getElementById("img5").src="images/MasksThumbnail4.jpg";
