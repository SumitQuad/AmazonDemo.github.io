...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('42') ";
...
<p style="color:blue;margin-left:2%;">TableWare</p>
...
document.getElementById("img5").src="images/TableWareThumbnail1.jpg";
...
document.getElementById("img5").src="images/TableWareThumbnail2.jpg";
...
document.getElementById("img5").src="images/TableWareThumbnail3.jpg";
...
document.getElementById("img5").src="images/TableWareThumbnail4.jpg";
