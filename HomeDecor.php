...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('8') ";
...
<p style="color:blue;margin-left:2%;">Clothes</p>
...
document.getElementById("img5").src="images/HomeDecorThumbnail1.jpg";
...
document.getElementById("img5").src="images/HomeDecorThumbnail2.jpg";
...
document.getElementById("img5").src="images/HomeDecorThumbnail3.jpg";
...
document.getElementById("img5").src="images/HomeDecorThumbnail4.jpg";
