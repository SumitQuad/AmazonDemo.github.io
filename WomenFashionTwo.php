...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('19') ";
...
<p style="color:blue;margin-left:2%;">Sandals</p>
...
document.getElementById("img5").src="images/WomenFashion70ThumbnailFive.jpg";
...
document.getElementById("img5").src="images/WomenFashion70ThumbnailSix.jpg";
...
document.getElementById("img5").src="images/WomenFashion70ThumbnailSeven.jpg";
...
document.getElementById("img5").src="images/WomenFashion70ThumbnailEight.jpg";
