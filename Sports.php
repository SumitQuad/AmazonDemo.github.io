...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('38') ";
...
<p style="color:blue;margin-left:2%;">Wireless Buds</p>
...
document.getElementById("img5").src="images/SportsThumbnail1.jpg";
...
document.getElementById("img5").src="images/SportsThumbnail2.jpg";
...
document.getElementById("img5").src="images/SportsThumbnail3.jpg";
...
document.getElementById("img5").src="images/SportsThumbnail4.jpg";
