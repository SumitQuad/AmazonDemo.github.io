...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('43') ";
...
<p style="color:blue;margin-left:2%;">Mat</p>
...
<p style="color:blue;margin-left:2%;">Mar</p>
...
document.getElementById("img5").src="images/HomeGymEquipment1.jpg";
...
document.getElementById("img5").src="images/HomeGymEquipment2.jpg";
...
document.getElementById("img5").src="images/HomeGymEquipment3.jpg";
...
document.getElementById("img5").src="images/HomeGymEquipment4.jpg";
