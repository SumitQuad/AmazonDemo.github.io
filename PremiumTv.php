...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('12') ";
...
<p style="color:blue;margin-left:2%;">Premium Tv</p>
...
document.getElementById("img5").src="images/PremierTelevisionThumbnail1.jpg";
...
document.getElementById("img5").src="images/PremierTelevisionThumbnail2.jpg";
...
document.getElementById("img5").src="images/PremierTelevisionThumbnail3.jpg";
...
document.getElementById("img5").src="images/PremierTelevisionThumbnail4.jpg";
