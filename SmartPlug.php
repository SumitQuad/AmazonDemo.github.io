...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('24') ";
...
<p style="color:blue;margin-left:2%;">Smart Plug</p>
...
document.getElementById("img5").src="images/SmartPlugThumbnail1.jpg";
...
document.getElementById("img5").src="images/SmartPlugThumbnail2.jpg";
...
document.getElementById("img5").src="images/SmartPlugThumbnail3.jpg";
...
document.getElementById("img5").src="images/SmartPlugThumbnail4.jpg";
