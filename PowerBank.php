...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('17') ";
...
<p style="color:blue;margin-left:2%;">Power Bank</p>
...
document.getElementById("img5").src="images/PowerBankThumbnail1.jpg";
...
document.getElementById("img5").src="images/PowerBankThumbnail2.jpg";
...
document.getElementById("img5").src="images/PowerBankThumbnail3.jpg";
...
document.getElementById("img5").src="images/PowerBankThumbnail4.jpg";
