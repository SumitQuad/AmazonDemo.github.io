...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('28') ";
...
<p style="color:blue;margin-left:2%;">Mixer Grinder</p>
...
document.getElementById("img5").src="images/MixerGrinderThumbnail1.jpg";
...
document.getElementById("img5").src="images/MixerGrinderThumbnail2.jpg";
...
document.getElementById("img5").src="images/MixerGrinderThumbnail3.jpg";
...
document.getElementById("img5").src="images/MixerGrinderThumbnail4.jpg";
