...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('1') ";
  ...
  <div class="header">
    ...
    padding-bottom: 0%;overflow-x:hidden;margin-right:0px;">
...
padding-right:5px;padding-left:5px;" id="img1">
...
padding-right:5px;padding-left:5px;margin-top:50%;"id="img4">
...
<p style="color:blue;margin-left:2%;">Vivo U10</p>
...
<!--Electric Blue Color Row-->
<div class="flex" style="margin-left:3%;border:1px solid black;padding-top:12px;margin-right:2%;
display:flex;flex-direction:row;">

<p style="color:black;font-size:14px;padding-left:3%;">Color:<span style="font-weight:bold;"> 
Electric Blue</span></p>
...
document.getElementById("img5").src="VivoU10.jpg";
...
document.getElementById("img5").src="VivoU10Thumbnail2.jpg";
...
document.getElementById("img5").src="VivoU10Thumbnail3.jpg";
...
document.getElementById("img5").src="VivoU10Thumbnail4.jpg";
