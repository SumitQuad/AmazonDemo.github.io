...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('4') ";
...
<p style="color:blue;margin-left:2%;">OnePlus 7T Pro</p>
...
document.getElementById("img5").src="images/OnePlus7TProThumbnail1.jpg";
...
document.getElementById("img5").src="images/OnePlus7TProThumbnail2.jpg";
...
document.getElementById("img5").src="images/OnePlus7TProThumbnail3.jpg";
...
document.getElementById("img5").src="images/OnePlus7TProThumbnail4.jpg";
