...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('37') ";
...
<p style="color:blue;margin-left:2%;">Wireless</p>
...
document.getElementById("img5").src="images/TrueWirelessThumbnail1.jpg";
...
document.getElementById("img5").src="images/TrueWirelessThumbnail2.jpg";
...
document.getElementById("img5").src="images/TrueWirelessThumbnail3.jpg";
...
document.getElementById("img5").src="images/TrueWirelessThumbnail4.jpg";
