...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('20') ";
...
<p style="color:blue;margin-left:2%;">Ear Rings</p>
...
document.getElementById("img5").src="images/WomenFashion70ThumbnailNine.jpg";
...
document.getElementById("img5").src="images/WomenFashion70ThumbnailTen.jpg";
...
document.getElementById("img5").src="images/WomenFashion70ThumbnailEleven.jpg";
