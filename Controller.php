...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('52') ";
...
<p style="color:blue;margin-left:2%;">Controller</p>
...
document.getElementById("img5").src="images/ControllerThumbnailOne.jpg";
...
document.getElementById("img5").src="images/ControllerThumbnailTwo.jpg";
...
document.getElementById("img5").src="images/ControllerThumbnailThree.jpg";
...
document.getElementById("img5").src="images/ControllerThumbnailFour.jpg";
