...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('18') ";
...
<p style="color:blue;margin-left:2%;">Jeans</p>
...
document.getElementById("img5").src="images/WomenFashion70ThumbnailOne.jpg";
...
document.getElementById("img5").src="images/WomenFashion70ThumbnailTwo.jpg";
...
document.getElementById("img5").src="images/WomenFashion70ThumbnailThree.jpg";
...
document.getElementById("img5").src="images/WomenFashion70ThumbnailFour.jpg";
