...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('10') ";
...
<p style="color:blue;margin-left:2%;">Television</p>
...
document.getElementById("img5").src="images/TelevisionThumbnail1.jpg";
...
document.getElementById("img5").src="images/TelevisionThumbnail2.jpg";
...
document.getElementById("img5").src="images/TelevisionThumbnail3.jpg";
...
document.getElementById("img5").src="images/TelevisionThumbnail4.jpg";
