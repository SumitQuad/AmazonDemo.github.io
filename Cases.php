...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('14') ";
...
<p style="color:blue;margin-left:2%;">Cases</p>
...
document.getElementById("img5").src="images/CasesThumbnail1.jpg";
...
document.getElementById("img5").src="images/CasesThumbnail2.jpg";
...
document.getElementById("img5").src="images/CasesThumbnail3.jpg";
...
document.getElementById("img5").src="images/CasesThumbnail4.jpg";
