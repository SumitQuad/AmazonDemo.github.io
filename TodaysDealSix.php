...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('48') ";
...
document.getElementById("img5").src="images/Deal6Thumbnail1.jpg";
...
document.getElementById("img5").src="images/Deal6Thumbnail2.jpg";
...
document.getElementById("img5").src="images/Deal6Thumbnail3.jpg";
...
document.getElementById("img5").src="images/Deal6Thumbnail4.jpg";
