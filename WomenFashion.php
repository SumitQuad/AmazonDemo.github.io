...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('6') ";
...
<p style="color:blue;margin-left:2%;">Crop</p>
...
document.getElementById("img5").src="images/WomenFashionThumbnail1.jpg";
...
document.getElementById("img5").src="images/WomenFashionThumbnail2.jpg";
...
document.getElementById("img5").src="images/WomenFashionThumbnail3.jpg";
