...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('23') ";
...
<p style="color:blue;margin-left:2%;">Alexa</p>
...
document.getElementById("img5").src="images/EchoDevicesThumbnail1.jpg";
...
document.getElementById("img5").src="images/EchoDevicesThumbnail2.jpg";
...
document.getElementById("img5").src="images/EchoDevicesThumbnail3.jpg";
...
document.getElementById("img5").src="images/EchoDevicesThumbnail4.jpg";
