...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('36') ";
...
<p style="color:blue;margin-left:2%;">Over Ear HeadPhone</p>
...
document.getElementById("img5").src="images/OverEarThumbnail1.jpg";
...
document.getElementById("img5").src="images/OverEarThumbnail2.jpg";
...
document.getElementById("img5").src="images/OverEarThumbnail3.jpg";
...
document.getElementById("img5").src="images/OverEarThumbnail4.jpg";
