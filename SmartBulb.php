...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('22') ";
...
<p style="color:blue;margin-left:2%;">Smart Bulb</p>
...
document.getElementById("img5").src="images/SmartBulbThumbnail1.jpg";
...
document.getElementById("img5").src="images/SmartBulbThumbnail2.jpg";
...
document.getElementById("img5").src="images/SmartBulbThumbnail3.jpg";
...
document.getElementById("img5").src="images/SmartBulbThumbnail4.jpg";
