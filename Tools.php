...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('31') ";
...
<p style="color:blue;margin-left:2%;">Grinder</p>
...
document.getElementById("img5").src="images/ToolsThumbnail1.jpg";
...
document.getElementById("img5").src="images/ToolsThumbnail2.jpg";
...
document.getElementById("img5").src="images/ToolsThumbnail3.jpg";
