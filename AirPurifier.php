...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('29') ";
...
<p style="color:blue;margin-left:2%;">Air Purifier</p>
...
document.getElementById("img5").src="images/AirPurifierThumbnail1.jpg";
...
document.getElementById("img5").src="images/AirPurifierThumbnail2.jpg";
...
document.getElementById("img5").src="images/AirPurifierThumbnail3.jpg";
