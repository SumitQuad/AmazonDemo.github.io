...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('9') ";
...
<p style="color:blue;margin-left:2%;">AC</p>
...
document.getElementById("img5").src="images/PreSummerThumbnail1.jpg";
...
document.getElementById("img5").src="images/PreSummerThumbnail2.jpg";
...
document.getElementById("img5").src="images/PreSummerThumbnail3.jpg";
...
document.getElementById("img5").src="images/PreSummerThumbnail4.jpg";
