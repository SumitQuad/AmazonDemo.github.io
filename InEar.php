...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('35') ";
...
<p style="color:blue;margin-left:2%;">InEar HeadPhones</p>
...
document.getElementById("img5").src="images/InEarThumbnail1.jpg";
...
document.getElementById("img5").src="images/InEarThumbnail2.jpg";
...
document.getElementById("img5").src="images/InEarThumbnail3.jpg";
...
document.getElementById("img5").src="images/InEarThumbnail4.jpg";
