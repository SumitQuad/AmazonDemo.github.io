...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('51') ";
...
document.getElementById("img5").src="images/CanonThumbnail1.jpg";
...
document.getElementById("img5").src="images/CanonThumbnail2.jpg";
...
document.getElementById("img5").src="images/CanonThumbnail3.jpg";
...
document.getElementById("img5").src="images/CanonThumbnail4.jpg";
