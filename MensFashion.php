...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('5') ";
...
document.getElementById("img5").src="images/MenThumbnail.jpg";
...
document.getElementById("img5").src="images/MenThumbnail1.jpg";
...
document.getElementById("img5").src="images/MenThumbnail2.jpg";
...
document.getElementById("img5").src="images/MenThumbnail3.jpg";
