...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('2') ";
...
<p style="color:blue;margin-left:2%;">Galaxy M30</p>
...
document.getElementById("img5").src="images/SamsungGalaxyM30.jpg";
...
document.getElementById("img5").src="images/SamsungGalaxyM30(1).jpg";
...
document.getElementById("img5").src="images/SamsungGalaxyM30(2).jpg";
...
document.getElementById("img5").src="images/SamsungGalaxyM30(3).jpg";
