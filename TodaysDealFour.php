...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('46') ";
...
<p style="color:blue;margin-left:2%;">Jacket</p>
...
document.getElementById("img5").src="images/Deal4Thumbnail1.jpg";
...
document.getElementById("img5").src="images/Deal4Thumbnail2.jpg";
...
document.getElementById("img5").src="images/Deal4Thumbnail3.jpg";
...
document.getElementById("img5").src="images/Deal4Thumbnail4.jpg";
