...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('7') ";
...
<p style="color:blue;margin-left:2%;">Airpods</p>
...
document.getElementById("img5").src="images/ElectronicsThumbnail1.jpg";
...
document.getElementById("img5").src="images/ElectronicsThumbnail2.jpg";
...
document.getElementById("img5").src="images/ElectronicsThumbnail3.jpg";
...
document.getElementById("img5").src="images/ElectronicsThumbnail4.jpg";
