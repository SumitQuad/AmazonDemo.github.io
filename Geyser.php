...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('26') ";
...
<p style="color:blue;margin-left:2%;">Geyser</p>
...
document.getElementById("img5").src="images/GeyserThumbnail1.jpg";
...
document.getElementById("img5").src="images/GeyserThumbnail2.jpg";
...
document.getElementById("img5").src="images/GeyserThumbnail3.jpg";
...
document.getElementById("img5").src="images/GeyserThumbnail4.jpg";
