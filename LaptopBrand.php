...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('13') ";
...
<p style="color:blue;margin-left:2%;">Laptop</p>
...
document.getElementById("img5").src="images/LaptopThumbnail1.jpg";
...
document.getElementById("img5").src="images/LaptopThumbnail2.jpg";
...
document.getElementById("img5").src="images/LaptopThumbnail3.jpg";
...
document.getElementById("img5").src="images/LaptopThumbnail4.jpg";
