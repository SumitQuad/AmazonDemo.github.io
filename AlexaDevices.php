...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('25') ";
...
<p style="color:blue;margin-left:2%;">FIRE TV STICK</p>
...
<img src="images/<?php echo
$product['Thumbnail1'];  ?>" alt="phone" class="img-fluid"style="width:3%;height:3%;margin-left:45%;">
...
document.getElementById("img5").src="images/AlexaDevicesThumbnail1.jpg";
...
document.getElementById("img5").src="images/AlexaDevicesThumbnail2.jpg";
...
document.getElementById("img5").src="images/AlexaDevicesThumbnail3.jpg";
...
document.getElementById("img5").src="images/AlexaDevicesThumbnail4.jpg";
