...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('41') ";
...
<p style="color:blue;margin-left:2%;">Bottle</p>
...
document.getElementById("img5").src="images/KitchenStorageThumbnail1.jpg";
...
document.getElementById("img5").src="images/KitchenStorageThumbnail2.jpg";
...
document.getElementById("img5").src="images/KitchenStorageThumbnail3.jpg";
...
document.getElementById("img5").src="images/KitchenStorageThumbnail4.jpg";
