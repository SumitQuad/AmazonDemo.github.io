...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('16') ";
...
<p style="color:blue;margin-left:2%;">Headsets</p>
...
document.getElementById("img5").src="images/HeadsetThumbnail1.jpg";
...
document.getElementById("img5").src="images/HeadsetThumbnail2.jpg";
...
document.getElementById("img5").src="images/HeadsetThumbnail3.jpg";
...
document.getElementById("img5").src="images/HeadsetThumbnail4.jpg";
