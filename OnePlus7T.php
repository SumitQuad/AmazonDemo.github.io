...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('3') ";
...
<p style="color:blue;margin-left:2%;">One Plus 7T</p>
...
document.getElementById("img5").src="images/OnePlus7TThumbnail1.jpg";
...
document.getElementById("img5").src="images/OnePlus7TThumbnail2.jpg";
...
document.getElementById("img5").src="images/OnePlus7TThumbnail3.jpg";
...
document.getElementById("img5").src="images/OnePlus7TThumbnail4.jpg";
