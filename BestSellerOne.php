...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('50') ";
...
<p style="color:blue;margin-left:2%;">Mi Band</p>
...
document.getElementById("img5").src="images/BestSellerThumbnail1.jpg";
...
document.getElementById("img5").src="images/BestSellerThumbnail2.jpg";
...
document.getElementById("img5").src="images/BestSellerThumbnail3.jpg";
...
document.getElementById("img5").src="images/BestSellerThumbnail4.jpg";
