...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('45') ";
...
<p style="color:blue;margin-left:2%;">HandBag</p>
...
document.getElementById("img5").src="images/Deal3Thumbnail1.jpg";
...
document.getElementById("img5").src="images/Deal3Thumbnail2.jpg";
...
document.getElementById("img5").src="images/Deal3Thumbnail3.jpg";
...
document.getElementById("img5").src="images/Deal3Thumbnail4.jpg";
