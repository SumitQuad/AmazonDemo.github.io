...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('30') ";
...
<p style="color:blue;margin-left:2%;">Camera</p>
...
document.getElementById("img5").src="images/FujfilmThumbnail1.jpg";
...
document.getElementById("img5").src="images/FujfilmThumbnail2.jpg";
...
document.getElementById("img5").src="images/FujfilmThumbnail3.jpg";
...
document.getElementById("img5").src="images/FujfilmThumbnail4.jpg";
