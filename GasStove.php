...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('39') ";
...
<p style="color:blue;margin-left:2%;">Gas Stove</p>
...
<p style="color:blue;margin-left:2%;">Gas Stoves</p>
...
document.getElementById("img5").src="images/GasStovesThumbnail1.jpg";
...
document.getElementById("img5").src="images/GasStovesThumbnail2.jpg";
...
document.getElementById("img5").src="images/GasStovesThumbnail3.jpg";
...
document.getElementById("img5").src="images/GasStovesThumbnail4.jpg";
