...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('47') ";
...
<p style="color:blue;margin-left:2%;">Vaccum Cleaner</p>
...
document.getElementById("img5").src="images/Deal5Thumbnail1.jpg";
...
document.getElementById("img5").src="images/Deal5Thumbnail2.jpg";
...
document.getElementById("img5").src="images/Deal5Thumbnail3.jpg";
...
document.getElementById("img5").src="images/Deal5Thumbnail4.jpg";
