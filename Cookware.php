...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('40') ";
...
<p style="color:blue;margin-left:2%;">Cookware</p>
...
document.getElementById("img5").src="images/CookWareThumbnail1.jpg";
...
document.getElementById("img5").src="images/CookWareThumbnail2.jpg";
...
document.getElementById("img5").src="images/CookWareThumbnail3.jpg";
...
document.getElementById("img5").src="images/CookWareThumbnail4.jpg";
