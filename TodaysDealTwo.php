...
<!-- Php starts Here -->
  <?php
    ...
    `Description5`,`Description6`,`Description7`
     FROM `amazontable` where Id In('44') ";
...
<p style="color:blue;margin-left:2%;">Mobile</p>
...
document.getElementById("img5").src="images/Deal2Thumbnail1.jpg";
...
document.getElementById("img5").src="images/Deal2Thumbnail2.jpg";
...
document.getElementById("img5").src="images/Deal2Thumbnail3.jpg";
...
document.getElementById("img5").src="images/Deal2Thumbnail4.jpg";
